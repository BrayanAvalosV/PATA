        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-600 max-w-2xl">
              Conoce las organizaciones que trabajan día a día para el bienestar
              animal.
            </p>
          </div>

          {/* 🔹 Botón que redirige al registro como fundación */}
          <Link
            to="/registro?tipo=fundacion"
            className="inline-flex items-center px-4 py-2 rounded-xl bg-green-600 text-white text-sm font-semibold hover:bg-green-700 shadow-sm"
          >
